...
typedef void (*servo_ctrl_set_pwm_t) (unsigned char cntl_addr, unsigned char servo_channel, unsigned int pos);
...
void servo_ctrl_add_device(servo_motor_t servos[NO_OF_SERVOS], unsigned char device_index, unsigned char pc9685_id, unsigned char channel, unsigned int high_pos_value, unsigned int center_pos_value,  unsigned int low_pos_value );
