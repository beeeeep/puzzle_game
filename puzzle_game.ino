...
#include "src/sound/sound_module.h"
...
#define SOUND_MODULE_PLAY_BUTTON
#define SOUND_MODULE_PAUSE_BUTTON
#define SOUND_MODULE_NEXT_BUTTON
#define SOUND_MODULE_PREVIOUS_BUTTON
#define SOUND_MODULE_VOLUME_UP_BUTTON
#define SOUND_MODULE_VOLUME_DOWN_BUTTON
...
void sound_module_button_play(void) {
    digitalWrite(SOUND_MODULE_PLAY_BUTTON, 1);

    digitalWrite(SOUND_MODULE_PLAY_BUTTON, 0);
}

void sound_module_button_pause(void) {
    digitalWrite(SOUND_MODULE_PAUSE_BUTTON, 1);

    digitalWrite(SOUND_MODULE_PAUSE_BUTTON, 0);
}

void sound_module_button_next(void) {
    digitalWrite(SOUND_MODULE_NEXT_BUTTON, 1);

    digitalWrite(SOUND_MODULE_NEXT_BUTTON, 0);
}

void sound_module_button_previous(void) {
    digitalWrite(SOUND_MODULE_NEXT_BUTTON, 1);

    digitalWrite(SOUND_MODULE_NEXT_BUTTON, 0);
}

void sound_module_button_volume_up(void) {
    digitalWrite(SOUND_MODULE_VOLUME_UP_BUTTON, 1);

    digitalWrite(SOUND_MODULE_VOLUME_UP_BUTTON, 0);
}

void sound_module_button_volume_down(void) {
    digitalWrite(SOUND_MODULE_VOLUME_DOWN_BUTTON, 1);

    digitalWrite(SOUND_MODULE_VOLUME_DOWN_BUTTON, 0);
}
...
void setup() {
    ...
    //********************** Sound Module init START ************************
    pinMode(SOUND_MODULE_PLAY_BUTTON, OUTPUT);
    pinMode(SOUND_MODULE_PAUSE_BUTTON, OUTPUT);
    pinMode(SOUND_MODULE_PREVIOUS_BUTTON, OUTPUT);
    pinMode(SOUND_MODULE_NEXT_BUTTON, OUTPUT);
    pinMode(SOUND_MODULE_VOLUME_UP_BUTTON, OUTPUT);
    pinMode(SOUND_MODULE_VOLUME_DOWN_BUTTON, OUTPUT);
    sound_module_init(sound_module_button_play, sound_module_button_pause, sound_module_button_next,
        sound_module_button_previous, sound_module_button_volume_up, sound_module_button_volume_down);


        //********************** Sound Module init END **************************
